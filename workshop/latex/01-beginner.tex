...
\textbf{Next opponent:} \code{cycle\_rps} repeats \throws{RPS} over and over. Write its first six moves and a winning reply under each one. How would your paper-only bot do?
\par
\clearpage
...
\toprule
\colhead{Completed throw} & \colhead{You played} & \colhead{Copycat played} & \colhead{What will Copycat play next?} \\
\midrule
\rule{0pt}{22pt}1 & \tR\ Rock & \tS\ Scissors &  \\
\rule{0pt}{22pt}2 & \tP\ Paper & \tR\ Rock &  \\
\rule{0pt}{22pt}3 & \tS\ Scissors & \tP\ Paper &  \\
\bottomrule
...
\begin{tabularx}{\linewidth}{@{}L{.25\linewidth}YYY@{}}
\toprule
\colhead{Version} & \colhead{Opponent and seed} & \colhead{Throws W-L-D} & \colhead{What did you learn?} \\
\midrule
